...
More often we enter our data in spreadsheets. We then need to import our data in [{{< fa brands r-project >}}]{.no-print} [**R**]{.print-only} to process them.<br>
...
if (knitr::is_html_output()) {
  ...
  cat("You can download the dataset on [GitHub](https://kmgjan.github.io/MED2024/MATERIAL/Part1/tutorial/assets)")
}
```
